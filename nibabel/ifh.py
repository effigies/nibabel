...
from .analyze import AnalyzeHeader, AnalyzeImage, header_key_dtd, data_history_dtd
...
interfile_dtd = [
    ('interfile', 'S32'),
    ('version_of_keys', 'S32'),
    ('conversion_program', 'S256'),
    ('name_of_data_file', 'S256'),
    ('number_format', 'S32'),
    ('imagedata_byte_order', 'S32'),
    ('number_of_bytes_per_pixel', 'i4'),
    ('number_of_dimensions', 'i4'),
    ('matrix_size', 'i4', (4,)),
    ('orientation', 'i4'),
    ('scaling_factor', 'f4', (4,)),
    ('mmppix', 'f4', (3,)),
...
_dtdefs = (  # code, conversion function, equivalent dtype, aliases
    (b'float', 'float32', np.float32),
    )

# Make full code alias bank, including dtype column
data_type_codes = make_dt_codes(_dtdefs)

bin_header_dtype = np.dtype(header_key_dtd + image_dimension_dtd +
                            data_history_dtd)
txt_header_dtype = np.dtype(interfile_dtd)


class InterfileBinHeader(AnalyzeHeader):
    template_dtype = bin_header_dtype
    _data_type_codes = data_type_codes
    _field_recoders = {'data_type': data_type_codes}

class InterfileHeader(LabeledWrapStruct):
    ...
    template_dtype = np.dtype(interfile_dtd)
    _data_type_codes = data_type_codes
